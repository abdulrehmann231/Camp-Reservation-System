...
{
    public partial class VerwijderReservering : Form
    {
        Methods met = new Methods();
        DataTable dtreservation = new DataTable();
        public VerwijderReservering()
        {
            InitializeComponent();
        }
        ...
        {//deze code verwijdert de reserveringen door de respectieve methode aan te roepen 
            ...
            {
                string id = dtreservation.Rows[reservationdata.CurrentRow.Index]["Reservation_ID"].ToString();
